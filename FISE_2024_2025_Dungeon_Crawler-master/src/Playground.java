...
public class Playground {
    ...
    private ArrayList<Sprite> traps = new ArrayList<>();
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)){
                    switch (element){
                        ...
                        case 'R' : environment.add(new SolidSprite(columnNumber*imageRockWidth,
                            ...
                            break;
                        case 'X' : traps.add(new Sprite(columnNumber*imageRockWidth,
    ...
    public ArrayList<Sprite> getSolidSpriteList_1(){
    ...
    public ArrayList<Sprite> getSolidSpriteList_2(){
        ArrayList <Sprite> solidSpriteArrayList = new ArrayList<>();
        for (Sprite sprite : traps){
            if (sprite instanceof SolidSprite) solidSpriteArrayList.add(sprite);
        }
        return solidSpriteArrayList;
    }
